...
if (isset($breaking_items) && count($breaking_items) > 0) {
  ...
  foreach ($breaking_items as $item) {
    ...
    print $item['title'];
    print '</div><div class="col-md-3 ads"><a href="//ad.broadstreetads.com/zone_static/35189/click/0"><img src="//ad.broadstreetads.com/zone_static/35189/image/0"/></a></div></div></div>';
    $i++;
    $first = '';
  }
  print '</div>';
