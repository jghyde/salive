...
jQuery.fn.sharebar = function(options) {
    ...
    var sharebar = (Drupal.settings.sharebar && Drupal.settings.sharebar.cls) ?
    jQuery(Drupal.settings.sharebar.cls) :
    jQuery('#sharebar');
    var sharebarx = (Drupal.settings.sharebar && Drupal.settings.sharebar.hrcls) ?
    jQuery(Drupal.settings.sharebar.hrcls) :
    jQuery('#sharebarx');    
