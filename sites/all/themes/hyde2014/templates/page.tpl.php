  ...
  <div class="main-container container">
    <div class="inner">
      ...
      <div class="row-fluid">
        ...
        <section class="<?php print _hyde2014_content_span($columns); ?>">  
          ...
          <?php if (!empty($page['form-below-content'])) {
            print render($page['form-below-content']);
          }
          ?>
        </section>   
...
<div class="footer-wrapper clearfix">
  <footer class="footer container">
	  <?php if (!empty($page['postscript-top'])): ?>
      <div class="span12 region bottom-leader">
