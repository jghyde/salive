...
<?php foreach ($rows as $id => $row): ?>
  ...
  <?php $i++; if ($i == $wrapper || $id == $last_row) print '</div><div class="col-md-12 news-insert"><div class="ads"><script type="text/javascript">broadstreet.zone(40775);</script></div></div>'; ?>
<?php endforeach; ?>
