...
drupal_add_js(drupal_get_path('theme', 'salive') . '/js/theme-settings.js');
	...
	require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'salive') . '/inc/theme-settings-general.inc';
	require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'salive') . '/inc/theme-settings-design.inc';
	require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'salive') . '/inc/theme-settings-text.inc';
	require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'salive') . '/inc/theme-settings-pages.inc';
	require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'salive') . '/inc/theme-settings-nodes.inc';
	require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'salive') . '/inc/theme-settings-sliders.inc';
	require_once DRUPAL_ROOT . '/' . drupal_get_path('theme', 'salive') . '/inc/theme-settings-code.inc';
...
<div class="md-wrap">
  <div id="md-tabs">
	...
	salive_theme_settings_generalsettings($form, $form_state);
	...
	salive_theme_settings_design($form, $form_state);
	salive_theme_settings_text($form, $form_state);
	salive_theme_settings_pages($form, $form_state);
	salive_theme_settings_nodes($form, $form_state);
	salive_theme_settings_sliders($form, $form_state);
	salive_theme_settings_code($form, $form_state);
