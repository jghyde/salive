  ...
  $.cbFlyNav.prototype = {
    ...
    _initEvents : function() {
      ...
      self.$newMenus.children().find('li').on('click.cbFlyNav', function(e) {
        e.stopPropagation();
        var $item = $(this),
            $subnav = $item.find('ul.subnavigation');
        ...
        if ($subnav.length > 0) {
          ...
          if(e.target.className == 'icon-cbmore'){
    ...
    _openSubNav : function($subnav) {
      ...
      $subnav.addClass('is-subnavigation-visible');
    ...
    _closeSubNav : function() {
      ...
      self.$openSubnav.removeClass('is-subnavigation-visible');
