...
include_once './' . drupal_get_path('theme', 'md_thenews') . '/inc/template.process.inc';
include_once './' . drupal_get_path('theme', 'md_thenews') . '/inc/template.pager.inc';
/**
 * Implementation of hook_theme().
 */
function md_thenews_theme() {
  $items = array();
 ...
 */
function md_thenews_menu_link(array $variables) {
 ...
 */
function md_thenews_menu_tree__primary(&$variables) {
 ...
 */
function md_thenews_field__taxonomy_term_reference($variables) {
  $output = '';
 ...
 */
function md_thenews_textarea($variables) {
  $element = $variables['element'];
